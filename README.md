...
- allows users to seamlessly transfer their music playlists between music streaming platforms, incorporating both the YouTube API and the Spotify API.
- allows users to merge their playlists from other platforms together before uploading it to another platform.
- allows users to create a new playlist with a custom image and add songs to it.
- Has search functionality that allows users to search for songs inside of the database to add to their own playlists.
